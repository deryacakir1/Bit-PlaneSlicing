...
"""
a =a = np.uint([10,25,50,100,160,200,255,248])
...
a_duzlemi = np.bitwise_and(a,bit_duzlemi)# bu iki arrayi and islemi yapalim
print(a_duzlemi)
"""
...
for index in range(7,-1,-1): #(start,stop,ilerleme durumu(burada -1 azalarak devam ediyor))
...
#Boyutlarini incelemek icin kaydediyoruz
...
cv2.imwrite("./img/out/7-6-5-4-3.png", img_duzlem5) #orijinale yakın görüntü ve boyutu kücük, 72 kB
cv2.imwrite("./img/out/7-6-5-4-3-2.png", img_duzlem6)
cv2.imwrite("./img/out/7-6-5-4-3-2-1.png", img_duzlem7)
cv2.imwrite("./img/out/7-6-5-4-3-2-1-0.png", img_duzlem8) #orijinal görüntü, 157 kB
